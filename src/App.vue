...
const isDark = ref(false); // Estado do Tema
...
<template>
  <div class="flex h-screen bg-[#FDFBFD] dark:bg-gray-900 font-sans text-gray-600 dark:text-gray-300 overflow-hidden transition-colors duration-300">
    ...
    <aside class="w-64 bg-white dark:bg-gray-800 border-r border-gray-100 dark:border-gray-700 hidden md:flex flex-col shadow-sm z-20 transition-colors duration-300">
        <div class="p-6 border-b border-gray-50 dark:border-gray-700 flex items-center gap-3">
    ...
    <div class="flex-1 flex flex-col h-screen overflow-hidden relative">
        <header class="md:hidden bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700 p-4 flex justify-between items-center z-30 sticky top-0">
            ...
            <div class="flex items-center gap-3">
                 <button @click="toggleDark" class="w-8 h-8 rounded-full bg-gray-100 dark:bg-gray-700 flex items-center justify-center text-gray-600 dark:text-yellow-400">
                    <i class="fa-solid" :class="isDark ? 'fa-sun' : 'fa-moon'"></i>
                </button>
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700">
                            ...
                            <ul class="space-y-4 text-sm text-gray-600 dark:text-gray-300">
                                ...
                                <li class="flex gap-3">
                                    <div class="min-w-[24px] h-6 rounded-full bg-gray-800 dark:bg-gray-600 text-white flex items-center justify-center text-xs font-bold">4</div>
